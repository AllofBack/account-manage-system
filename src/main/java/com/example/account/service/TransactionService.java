...
public class TransactionService {
    ...
    private Transaction saveAndGetTransaction(TransactionType transactionType,
        ...
        return transactionRepository.save(
                Transaction.builder()
                        ...
                        .transactionId(UUID.randomUUID().toString().replace("-", "")) // 가장 많이 쓰이고 검증된 방법, UUID (고유 번호 부여)
    ...
    public TransactionDto cancelBalance(String transactionId, String accountNumber, Long amount){
        ...
        validateCancelBalance(transaction, account, amount); // 예외처리
    ...
    private void validateCancelBalance(Transaction transaction, Account account, Long amount) {
        ...
        if (!Objects.equals(transaction.getAmount(), amount)){
            throw new AccountException(ErrorCode.CANCELE_MUST_FULLY);
        }
